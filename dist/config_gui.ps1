...
$guiDir = Split-Path -Parent $PSCommandPath
$avatarImagePath = Join-Path $guiDir 'avatar.png'
...
$minimizeImagePath = Join-Path $guiDir 'minimize_avatar.png'
...
$maximizeImagePath = Join-Path $guiDir 'maximize_avatar.png'
...
$closeImagePath = Join-Path $guiDir 'close_avatar.png'
